...
declare module 'ludobits.m.flow' {
    ...
    export function start(fn: Callback, options?: { parallel?: boolean }, on_error?: CallbackError): Coroutine;
    export function parallel(fn: Callback, on_error?: CallbackError): Coroutine;
    ...
    export function gui_animate(node: node, property: string | hash, playback: any, to: number | vmath.vector3 | vmath.vector4 | vmath.quaternion, easing: any, duration: number, delay?: number): void;
}
